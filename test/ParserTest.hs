...
simpleV' t str = ExprUnit (ValueExpr (SimpleV (t str)))
complexV str vs = ValueExpr (ComplexV (WrapValues str vs))
complexV' str vs = ExprUnit (ValueExpr (ComplexV (WrapValues str vs)))
...
variableExprTest =
  [ "assign" ~: parse ast "" "a\n" ~?=
    Right (AST [ExprUnit (VariableExpr "a")])
  , "assign" ~: parse ast "" "a1\n" ~?=
    Right (AST [ExprUnit (VariableExpr "a1")])
  , "assign" ~: parse ast "" "aA\n" ~?=
    Right (AST [ExprUnit (VariableExpr "aA")])
  , "assign" ~: parse ast "" "a1A\n" ~?=
    Right (AST [ExprUnit (VariableExpr "a1A")])
  ]
